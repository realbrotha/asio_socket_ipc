 ...
 *     });
 *
 * // Start the io_context until it runs out of work.
...
public:
  ...
  /// Start the io_context object's event processing loop.
  /**
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
  /// (Deprecated: Use non-error_code overload.) Start the io_context object's
  ...
  /// Start the io_context object's event processing loop for a specified
  /// duration.
  /**
  ...
  /// Start the io_context object's event processing loop until a specified time.
  /**
  ...
  /// Start the io_context object's event processing loop to execute at most one
  /// handler.
  /**
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
  /// (Deprecated: Use non-error_code overlaod.) Start the io_context object's
...
#if defined(BOOST_ASIO_HAS_CHRONO) || defined(GENERATING_DOCUMENTATION)
  /// Start the io_context object's event processing loop for a specified duration
  ...
  /// Start the io_context object's event processing loop to execute ready
  /// handlers.
  /**
  ...
  /// Start the io_context object's event processing loop to execute one ready
  /// handler.
  /**
